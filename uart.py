...
try:
        ...
        while True:
            ...
            if data:  # 데이터가 비어있지 않으면 출력
                ...
                Robot_time,l_hip_angle,r_hip_angle,l_hip_velocity,r_hip_velocity,l_hip_torque,r_hip_torque,l_hip_targetspeed,r_hip_targetspeed,control_mode,control_interval=split_data
                ...
                print(f"l_hip_velocity: {r_hip_velocity}")
